...
*Примечание: При выполнении проекта были выгружены все данные из таблицы. В целом это не рекомендуется делать, т.к. данные могут быть достаточно объемные. В проекте этим я пренебрегла, в связи с небольшим объемом данных.*
